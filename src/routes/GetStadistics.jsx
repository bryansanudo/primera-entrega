    ...
    <>
          ...
          <div className="mt-8 sm:mt-12">
            <dl className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <div className="flex flex-col rounded-lg border border-gray-100 px-4 py-8 text-center">
                ...
                <dd className="text-4xl font-extrabold text-[#36b5d3] md:text-5xl">
                  $4.8m
                </dd>
              </div>
      ...
      <section className="px-4 py-20 mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-16 lg:gap-x-24 gap-y-20">
          ...
          <div>
            <div className="flex items-center justify-center w-8 h-8 mb-4 text-[#36b5d3] bg-blue-100 rounded-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
                fill="currentColor"
